    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">payment</h3>
...
<BR><table id="dataTable" class="table table-bordered table-striped">
            ...
            <?php while($row = $result->fetch_assoc()) { 
              ...
              <tr>
				...
				<a href="#" onclick="deleteItem(<?php echo $row['payment_id']; ?>);" class="btn btn-sm btn-danger">
              ...
              <td><?php echo $row['sameaddress'] ?></td>
              <td><?php echo $row['saveinfo'] ?></td>
              <td><?php echo $row['bank_pay'] ?></td>
              <td><?php echo $row['payment_date'] ?></td>
              <td><?php echo $row['hour'] ?></td>
              <td><?php echo $row['minute'] ?></td>
              <td><a href="../../../upload/<?php echo $row['slip'] ?>" target="_blank"><img src="../../../upload/<?php echo $row['slip'] ?>" width="100"></a></td>
              </tr>
            <?php } ?>
            </tbody>
          </table>
