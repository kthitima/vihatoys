          ...
          <table id="dataTable" class="table table-bordered table-striped">
            ...
            <?php while($row = $result->fetch_assoc()) { 
              ...
              <tr>
                ...
                <td><img class="img-fluid d-block mx-auto" src="../product/upload/<?php  echo $row['product_img_name']?>" width="150px" alt=""></td>
                <td><?php echo $row['product_name'] ?></td>
                <td  class="desc" style="max-width:400px;"><?php echo $row['product_desc'] ?></td>
