...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || Dochoimebe</title>
  ...
  <body>
    ...
    <div class="row" style="margin: 10em auto;">
      <div class="large-12">
        <?php
          ...
          echo '<td>'.ViToUsd($total).'</td>';
          echo '</tr>';

          echo '<tr>';
          echo '<td colspan="4" align="right"><a href="update-cart.php?action=empty" class="button alert">Empty Cart</a>&nbsp;<a href="products.php" class="button [secondary success alert]" style="background-color: #43ac6a;
          border-color: #368a55;
          color: white;
          line-height: 12px;
          border-radius: 4px;">Continue Shopping</a>';
          if(isset($_SESSION['username'])) {
            echo '<a href="orders-update.php"><button style="float:right;">Confirm</button></a>';
          }
